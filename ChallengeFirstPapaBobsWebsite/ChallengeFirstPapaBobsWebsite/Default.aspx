...
<body>
    <h1>
        ...
        <img alt="" class="auto-style4" src="pusheenpizza.png" />Tay&#39;s Pusheen Pizza </span></h1>
    <form id="form1" runat="server">
        <p>
            <asp:RadioButton ID="smallRadioButton" runat="server" GroupName="SizeGroup" Text="Baby Cat Size (10&quot;) - $10" />
            <br />
            <asp:RadioButton ID="mediumRadioButton" runat="server" GroupName="SizeGroup" Text="Mama Cat Size (13&quot;) - $13" />
            <br />
            <asp:RadioButton ID="largeRadioButton" runat="server" GroupName="SizeGroup" Text="Papa Cat Size (16&quot;) - $16" />
            <br />
        </p>
        <p>
        ...
        <h3 class="auto-style2">Tay&#39;s <span class="auto-style3">Special Deal</span></h3>
        <p>
